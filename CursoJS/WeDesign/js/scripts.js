...
document.getElementById("service-next").onclick = function(){
  if (servico_atual == our_services.length -1){
    var servico_seguine = 0;

  }else {
    var servico_seguine = servico_atual +1;
  
  }
  document.getElementById("service-title").innerHTML = our_services[servico_seguine].title;
  document.getElementById("service-text").innerHTML = our_services[servico_seguine].text;
  servico_atual = servico_seguine;
...
// chave api google : AIzaSyBfFohfJ0V5QekE_BJ_tV8TasoalMKGiLQ
